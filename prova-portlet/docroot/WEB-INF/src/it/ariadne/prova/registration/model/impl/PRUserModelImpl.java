...
import it.ariadne.prova.registration.model.PRUserModel;
...
/**
 * The base model implementation for the PRUser service. Represents a row in the &quot;prreg_PRUser&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This implementation and its corresponding interface {@link it.ariadne.prova.registration.model.PRUserModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link PRUserImpl}.
 * </p>
 *
 * @author Politi
 * @see PRUserImpl
 * @see it.ariadne.prova.registration.model.PRUser
 * @see it.ariadne.prova.registration.model.PRUserModel
 * @generated
 */
public class PRUserModelImpl extends BaseModelImpl<PRUser>
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. All methods that expect a p r user model instance should use the {@link it.ariadne.prova.registration.model.PRUser} interface instead.
	 */
	public static final String TABLE_NAME = "prreg_PRUser";
	...
	public static final String TABLE_SQL_CREATE = "create table prreg_PRUser (prUserId LONG not null primary key,firstName VARCHAR(75) null,lastName VARCHAR(75) null,address1 VARCHAR(75) null,address2 VARCHAR(75) null,city VARCHAR(75) null,state_ VARCHAR(75) null,postalCode VARCHAR(75) null,country VARCHAR(75) null,phoneNumber VARCHAR(75) null,email VARCHAR(75) null,birthDate DATE null,male BOOLEAN,gender VARCHAR(75) null,userId LONG,companyId LONG,groupId LONG)";
	public static final String TABLE_SQL_DROP = "drop table prreg_PRUser";
	public static final String ORDER_BY_JPQL = " ORDER BY prUser.lastName ASC";
	public static final String ORDER_BY_SQL = " ORDER BY prreg_PRUser.lastName ASC";
	public static final String DATA_SOURCE = "liferayDataSource";
	public static final String SESSION_FACTORY = "liferaySessionFactory";
	public static final String TX_MANAGER = "liferayTransactionManager";
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.entity.cache.enabled.it.ariadne.prova.registration.model.PRUser"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.finder.cache.enabled.it.ariadne.prova.registration.model.PRUser"),
			true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.column.bitmask.enabled.it.ariadne.prova.registration.model.PRUser"),
			true);
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.util.service.ServiceProps.get(
				"lock.expiration.time.it.ariadne.prova.registration.model.PRUser"));
	...
	public Object clone() {
		...
		prUserImpl.setGender(getGender());
	...
	public CacheModel<PRUser> toCacheModel() {
		...
		prUserCacheModel.gender = getGender();

		String gender = prUserCacheModel.gender;

		if ((gender != null) && (gender.length() == 0)) {
			prUserCacheModel.gender = null;
		}
