...
import it.ariadne.prova.registration.model.PRRegistrationModel;
...
/**
 * The base model implementation for the PRRegistration service. Represents a row in the &quot;prreg_PRRegistration&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This implementation and its corresponding interface {@link it.ariadne.prova.registration.model.PRRegistrationModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link PRRegistrationImpl}.
 * </p>
 *
 * @author Politi
 * @see PRRegistrationImpl
 * @see it.ariadne.prova.registration.model.PRRegistration
 * @see it.ariadne.prova.registration.model.PRRegistrationModel
 * @generated
 */
public class PRRegistrationModelImpl extends BaseModelImpl<PRRegistration>
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. All methods that expect a p r registration model instance should use the {@link it.ariadne.prova.registration.model.PRRegistration} interface instead.
	 */
	public static final String TABLE_NAME = "prreg_PRRegistration";
	...
	public static final String TABLE_SQL_CREATE = "create table prreg_PRRegistration (registrationId LONG not null primary key,prUserId LONG,datePurchased DATE null,howHear VARCHAR(75) null,wherePurchased VARCHAR(75) null,serialNumber VARCHAR(75) null,productId LONG,companyId LONG,groupId LONG)";
	public static final String TABLE_SQL_DROP = "drop table prreg_PRRegistration";
	public static final String ORDER_BY_JPQL = " ORDER BY prRegistration.registrationId ASC";
	public static final String ORDER_BY_SQL = " ORDER BY prreg_PRRegistration.registrationId ASC";
	public static final String DATA_SOURCE = "liferayDataSource";
	public static final String SESSION_FACTORY = "liferaySessionFactory";
	public static final String TX_MANAGER = "liferayTransactionManager";
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.entity.cache.enabled.it.ariadne.prova.registration.model.PRRegistration"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.finder.cache.enabled.it.ariadne.prova.registration.model.PRRegistration"),
			true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.column.bitmask.enabled.it.ariadne.prova.registration.model.PRRegistration"),
			true);
	...
	public static final String MAPPING_TABLE_PRREG_PRUSER_PRREGISTRATION_NAME = "prreg_PRUser_PRRegistration";
	public static final Object[][] MAPPING_TABLE_PRREG_PRUSER_PRREGISTRATION_COLUMNS =
		{
			{ "registrationId", Types.BIGINT },
			{ "prUserId", Types.BIGINT }
		};
	public static final String MAPPING_TABLE_PRREG_PRUSER_PRREGISTRATION_SQL_CREATE =
		"create table prreg_PRUser_PRRegistration (registrationId LONG not null,prUserId LONG not null,primary key (registrationId, prUserId))";
	public static final boolean FINDER_CACHE_ENABLED_PRREG_PRUSER_PRREGISTRATION =
		GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.finder.cache.enabled.prreg_PRUser_PRRegistration"),
			true);
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.util.service.ServiceProps.get(
				"lock.expiration.time.it.ariadne.prova.registration.model.PRRegistration"));
