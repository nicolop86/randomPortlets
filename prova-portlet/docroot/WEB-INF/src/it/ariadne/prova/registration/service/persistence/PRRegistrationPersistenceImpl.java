...
import it.ariadne.prova.registration.NoSuchPRRegistrationException;
...
import it.ariadne.prova.registration.model.impl.PRRegistrationModelImpl;
...
public class PRRegistrationPersistenceImpl extends BasePersistenceImpl<PRRegistration>
	...
	protected PRRegistration removeImpl(PRRegistration prRegistration)
		...
		prRegistrationToPRUserTableMapper.deleteLeftPrimaryKeyTableMappings(prRegistration.getPrimaryKey());
	 ...
	 */
	@Override
	public List<it.ariadne.prova.registration.model.PRUser> getPRUsers(long pk)
		throws SystemException {
		return getPRUsers(pk, QueryUtil.ALL_POS, QueryUtil.ALL_POS);
	}
	 ...
	 */
	@Override
	public List<it.ariadne.prova.registration.model.PRUser> getPRUsers(
		long pk, int start, int end) throws SystemException {
		return getPRUsers(pk, start, end, null);
	}
	...
	public List<it.ariadne.prova.registration.model.PRUser> getPRUsers(
		...
		throws SystemException {
		return prRegistrationToPRUserTableMapper.getRightBaseModels(pk, start,
	 ...
	 */
	@Override
	public int getPRUsersSize(long pk) throws SystemException {
		long[] pks = prRegistrationToPRUserTableMapper.getRightPrimaryKeys(pk);
	...
	public boolean containsPRUser(long pk, long prUserPK)
		throws SystemException {
		return prRegistrationToPRUserTableMapper.containsTableMapping(pk,
			prUserPK);
	}
	 ...
	 */
	@Override
	public boolean containsPRUsers(long pk) throws SystemException {
		if (getPRUsersSize(pk) > 0) {
			return true;
		}
		else {
			return false;
	...
	public void addPRUser(long pk,
		...
		throws SystemException {
		prRegistrationToPRUserTableMapper.addTableMapping(pk,
			prUser.getPrimaryKey());
	}
	 ...
	 */
	@Override
	public void addPRUsers(long pk, long[] prUserPKs) throws SystemException {
		for (long prUserPK : prUserPKs) {
			prRegistrationToPRUserTableMapper.addTableMapping(pk, prUserPK);
		}
	}
	...
	public void addPRUsers(long pk,
		List<it.ariadne.prova.registration.model.PRUser> prUsers)
		throws SystemException {
		for (it.ariadne.prova.registration.model.PRUser prUser : prUsers) {
			prRegistrationToPRUserTableMapper.addTableMapping(pk,
				prUser.getPrimaryKey());
		}
	}
	 ...
	 */
	@Override
	public void clearPRUsers(long pk) throws SystemException {
		prRegistrationToPRUserTableMapper.deleteLeftPrimaryKeyTableMappings(pk);
	}
	 ...
	 */
	@Override
	public void removePRUser(long pk, long prUserPK) throws SystemException {
		prRegistrationToPRUserTableMapper.deleteTableMapping(pk, prUserPK);
	}
	...
	public void removePRUser(long pk,
		it.ariadne.prova.registration.model.PRUser prUser)
		throws SystemException {
		prRegistrationToPRUserTableMapper.deleteTableMapping(pk,
			prUser.getPrimaryKey());
	}
	 ...
	 */
	@Override
	public void setPRUsers(long pk, long[] prUserPKs) throws SystemException {
		Set<Long> newPRUserPKsSet = SetUtil.fromArray(prUserPKs);
		Set<Long> oldPRUserPKsSet = SetUtil.fromArray(prRegistrationToPRUserTableMapper.getRightPrimaryKeys(
					pk));

		Set<Long> removePRUserPKsSet = new HashSet<Long>(oldPRUserPKsSet);

		removePRUserPKsSet.removeAll(newPRUserPKsSet);

		for (long removePRUserPK : removePRUserPKsSet) {
			prRegistrationToPRUserTableMapper.deleteTableMapping(pk,
				removePRUserPK);
		}

		newPRUserPKsSet.removeAll(oldPRUserPKsSet);

		for (long newPRUserPK : newPRUserPKsSet) {
			prRegistrationToPRUserTableMapper.addTableMapping(pk, newPRUserPK);
		}
	}
	...
	public void setPRUsers(long pk,
		...
		throws SystemException {
		try {
			long[] prUserPKs = new long[prUsers.size()];

			for (int i = 0; i < prUsers.size(); i++) {
				it.ariadne.prova.registration.model.PRUser prUser = prUsers.get(i);

				prUserPKs[i] = prUser.getPrimaryKey();
			}

			setPRUsers(pk, prUserPKs);
		}
		catch (Exception e) {
			throw processException(e);
		}
		finally {
			FinderCacheUtil.clearCache(PRRegistrationModelImpl.MAPPING_TABLE_PRREG_PRUSER_PRREGISTRATION_NAME);
		}
	}
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.it.ariadne.prova.registration.model.PRRegistration")));
		...
		prRegistrationToPRUserTableMapper = TableMapperFactory.getTableMapper("prreg_PRUser_PRRegistration",
				"registrationId", "prUserId", this, prUserPersistence);
	}
	...
	protected TableMapper<PRRegistration, it.ariadne.prova.registration.model.PRUser> prRegistrationToPRUserTableMapper;
	...
	private static final String _FILTER_SQL_SELECT_PRREGISTRATION_WHERE = "SELECT DISTINCT {prRegistration.*} FROM prreg_PRRegistration prRegistration WHERE ";
	private static final String _FILTER_SQL_SELECT_PRREGISTRATION_NO_INLINE_DISTINCT_WHERE_1 =
		"SELECT {prreg_PRRegistration.*} FROM (SELECT DISTINCT prRegistration.registrationId FROM prreg_PRRegistration prRegistration WHERE ";
	private static final String _FILTER_SQL_SELECT_PRREGISTRATION_NO_INLINE_DISTINCT_WHERE_2 =
		") TEMP_TABLE INNER JOIN prreg_PRRegistration ON TEMP_TABLE.registrationId = prreg_PRRegistration.registrationId";
	private static final String _FILTER_SQL_COUNT_PRREGISTRATION_WHERE = "SELECT COUNT(DISTINCT prRegistration.registrationId) AS COUNT_VALUE FROM prreg_PRRegistration prRegistration WHERE ";
	private static final String _FILTER_ENTITY_ALIAS = "prRegistration";
	private static final String _FILTER_ENTITY_TABLE = "prreg_PRRegistration";
	private static final String _ORDER_BY_ENTITY_ALIAS = "prRegistration.";
	private static final String _ORDER_BY_ENTITY_TABLE = "prreg_PRRegistration.";
