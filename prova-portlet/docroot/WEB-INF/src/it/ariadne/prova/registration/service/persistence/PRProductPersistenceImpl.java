...
import it.ariadne.prova.registration.model.impl.PRProductModelImpl;
...
public class PRProductPersistenceImpl extends BasePersistenceImpl<PRProduct>
	...
	public PRProduct findByG_PN_First(long groupId, String productName,
		...
		throws NoSuchPRProductException, SystemException {
		...
		throw new NoSuchPRProductException(msg.toString());
	}
	...
	public PRProduct remove(Serializable primaryKey)
		...
		try {
			...
			if (prProduct == null) {
				...
				throw new NoSuchPRProductException(_NO_SUCH_ENTITY_WITH_PRIMARY_KEY +
					primaryKey);
			}

			return remove(prProduct);
		}
		catch (NoSuchPRProductException nsee) {
			throw nsee;
		}
		catch (Exception e) {
			throw processException(e);
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.it.ariadne.prova.registration.model.PRProduct")));
	...
	private static final String _FILTER_SQL_SELECT_PRPRODUCT_WHERE = "SELECT DISTINCT {prProduct.*} FROM prreg_PRProduct prProduct WHERE ";
	private static final String _FILTER_SQL_SELECT_PRPRODUCT_NO_INLINE_DISTINCT_WHERE_1 =
		"SELECT {prreg_PRProduct.*} FROM (SELECT DISTINCT prProduct.productId FROM prreg_PRProduct prProduct WHERE ";
	private static final String _FILTER_SQL_SELECT_PRPRODUCT_NO_INLINE_DISTINCT_WHERE_2 =
		") TEMP_TABLE INNER JOIN prreg_PRProduct ON TEMP_TABLE.productId = prreg_PRProduct.productId";
	private static final String _FILTER_SQL_COUNT_PRPRODUCT_WHERE = "SELECT COUNT(DISTINCT prProduct.productId) AS COUNT_VALUE FROM prreg_PRProduct prProduct WHERE ";
	private static final String _FILTER_ENTITY_ALIAS = "prProduct";
	private static final String _FILTER_ENTITY_TABLE = "prreg_PRProduct";
	private static final String _ORDER_BY_ENTITY_ALIAS = "prProduct.";
	private static final String _ORDER_BY_ENTITY_TABLE = "prreg_PRProduct.";
