...
import it.ariadne.prova.registration.NoSuchPRUserException;
import it.ariadne.prova.registration.model.PRUser;
import it.ariadne.prova.registration.model.impl.PRUserImpl;
import it.ariadne.prova.registration.model.impl.PRUserModelImpl;
...
public class PRUserPersistenceImpl extends BasePersistenceImpl<PRUser>
	...
	protected PRUser removeImpl(PRUser prUser) throws SystemException {
		...
		prUserToPRRegistrationTableMapper.deleteLeftPrimaryKeyTableMappings(prUser.getPrimaryKey());
	...
	@Override
	public PRUser updateImpl(it.ariadne.prova.registration.model.PRUser prUser)
		throws SystemException {
		prUser = toUnwrappedModel(prUser);
	...
	protected PRUser toUnwrappedModel(PRUser prUser) {
		...
		prUserImpl.setGender(prUser.getGender());
	 ...
	 */
	@Override
	public List<it.ariadne.prova.registration.model.PRRegistration> getPRRegistrations(
	...
	public List<it.ariadne.prova.registration.model.PRRegistration> getPRRegistrations(
		...
		throws SystemException {
		return prUserToPRRegistrationTableMapper.getRightBaseModels(pk, start,
	...
	public int getPRRegistrationsSize(long pk) throws SystemException {
		long[] pks = prUserToPRRegistrationTableMapper.getRightPrimaryKeys(pk);
	...
	public boolean containsPRRegistration(long pk, long prRegistrationPK)
		throws SystemException {
		return prUserToPRRegistrationTableMapper.containsTableMapping(pk,
			prRegistrationPK);
	}
	...
	public void addPRRegistration(long pk, long prRegistrationPK)
		throws SystemException {
		prUserToPRRegistrationTableMapper.addTableMapping(pk, prRegistrationPK);
	}
	...
	public void addPRRegistration(long pk,
		...
		throws SystemException {
		prUserToPRRegistrationTableMapper.addTableMapping(pk,
			prRegistration.getPrimaryKey());
	}
	...
	public void addPRRegistrations(long pk, long[] prRegistrationPKs)
		throws SystemException {
		for (long prRegistrationPK : prRegistrationPKs) {
			prUserToPRRegistrationTableMapper.addTableMapping(pk,
				prRegistrationPK);
		}
	}
	...
	public void addPRRegistrations(long pk,
		List<it.ariadne.prova.registration.model.PRRegistration> prRegistrations)
		throws SystemException {
		for (it.ariadne.prova.registration.model.PRRegistration prRegistration : prRegistrations) {
			prUserToPRRegistrationTableMapper.addTableMapping(pk,
				prRegistration.getPrimaryKey());
		}
	}
	 ...
	 */
	@Override
	public void clearPRRegistrations(long pk) throws SystemException {
		prUserToPRRegistrationTableMapper.deleteLeftPrimaryKeyTableMappings(pk);
	}
	...
	public void removePRRegistration(long pk, long prRegistrationPK)
		throws SystemException {
		prUserToPRRegistrationTableMapper.deleteTableMapping(pk,
			prRegistrationPK);
	}
	...
	public void setPRRegistrations(long pk, long[] prRegistrationPKs)
		throws SystemException {
		Set<Long> newPRRegistrationPKsSet = SetUtil.fromArray(prRegistrationPKs);
		Set<Long> oldPRRegistrationPKsSet = SetUtil.fromArray(prUserToPRRegistrationTableMapper.getRightPrimaryKeys(
					pk));

		Set<Long> removePRRegistrationPKsSet = new HashSet<Long>(oldPRRegistrationPKsSet);

		removePRRegistrationPKsSet.removeAll(newPRRegistrationPKsSet);

		for (long removePRRegistrationPK : removePRRegistrationPKsSet) {
			prUserToPRRegistrationTableMapper.deleteTableMapping(pk,
				removePRRegistrationPK);
		}

		newPRRegistrationPKsSet.removeAll(oldPRRegistrationPKsSet);

		for (long newPRRegistrationPK : newPRRegistrationPKsSet) {
			prUserToPRRegistrationTableMapper.addTableMapping(pk,
				newPRRegistrationPK);
		}
	}
	...
	public void setPRRegistrations(long pk,
		...
		throws SystemException {
		try {
			long[] prRegistrationPKs = new long[prRegistrations.size()];

			for (int i = 0; i < prRegistrations.size(); i++) {
				it.ariadne.prova.registration.model.PRRegistration prRegistration =
					prRegistrations.get(i);

				prRegistrationPKs[i] = prRegistration.getPrimaryKey();
			}

			setPRRegistrations(pk, prRegistrationPKs);
		}
		catch (Exception e) {
			throw processException(e);
		}
		finally {
			FinderCacheUtil.clearCache(PRUserModelImpl.MAPPING_TABLE_PRREG_PRUSER_PRREGISTRATION_NAME);
		}
	}
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.it.ariadne.prova.registration.model.PRUser")));
		...
		prUserToPRRegistrationTableMapper = TableMapperFactory.getTableMapper("prreg_PRUser_PRRegistration",
				"prUserId", "registrationId", this, prRegistrationPersistence);
	}
	...
	protected TableMapper<PRUser, it.ariadne.prova.registration.model.PRRegistration> prUserToPRRegistrationTableMapper;
	...
	private static final String _FILTER_SQL_SELECT_PRUSER_WHERE = "SELECT DISTINCT {prUser.*} FROM prreg_PRUser prUser WHERE ";
	private static final String _FILTER_SQL_SELECT_PRUSER_NO_INLINE_DISTINCT_WHERE_1 =
		"SELECT {prreg_PRUser.*} FROM (SELECT DISTINCT prUser.prUserId FROM prreg_PRUser prUser WHERE ";
	private static final String _FILTER_SQL_SELECT_PRUSER_NO_INLINE_DISTINCT_WHERE_2 =
		") TEMP_TABLE INNER JOIN prreg_PRUser ON TEMP_TABLE.prUserId = prreg_PRUser.prUserId";
	private static final String _FILTER_SQL_COUNT_PRUSER_WHERE = "SELECT COUNT(DISTINCT prUser.prUserId) AS COUNT_VALUE FROM prreg_PRUser prUser WHERE ";
	private static final String _FILTER_ENTITY_ALIAS = "prUser";
	private static final String _FILTER_ENTITY_TABLE = "prreg_PRUser";
	private static final String _ORDER_BY_ENTITY_ALIAS = "prUser.";
	private static final String _ORDER_BY_ENTITY_TABLE = "prreg_PRUser.";
