...
public class PRProductLocalServiceClp implements PRProductLocalService {
	...
	public it.ariadne.prova.registration.model.PRProduct addPRProduct(
		...
		return (it.ariadne.prova.registration.model.PRProduct)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<it.ariadne.prova.registration.model.PRProduct> getPRProducts(
		...
		return (java.util.List<it.ariadne.prova.registration.model.PRProduct>)ClpSerializer.translateOutput(returnObj);
	}
	...
	public void deleteProduct(long productId)
		...
		try {
			...
			if (t instanceof it.ariadne.prova.registration.NoSuchPRProductException) {
				throw (it.ariadne.prova.registration.NoSuchPRProductException)t;
			}
