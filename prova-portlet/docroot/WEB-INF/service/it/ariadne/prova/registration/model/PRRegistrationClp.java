...
public class PRRegistrationClp extends BaseModelImpl<PRRegistration>
	...
	public int compareTo(PRRegistration prRegistration) {
		...
		if (getRegistrationId() < prRegistration.getRegistrationId()) {
			value = -1;
		}
		else if (getRegistrationId() > prRegistration.getRegistrationId()) {
			value = 1;
		}
		else {
			value = 0;
	...
	public String toXmlString() {
		...
		sb.append("it.ariadne.prova.registration.model.PRRegistration");
