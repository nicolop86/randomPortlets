...
public class PRUserWrapper implements PRUser, ModelWrapper<PRUser> {
	...
	*/
	...
	@Override
	public int compareTo(it.ariadne.prova.registration.model.PRUser prUser) {
	...
	@Override
	public com.liferay.portal.model.CacheModel<it.ariadne.prova.registration.model.PRUser> toCacheModel() {
		return _prUser.toCacheModel();
	}

	@Override
	public it.ariadne.prova.registration.model.PRUser toEscapedModel() {
		return new PRUserWrapper(_prUser.toEscapedModel());
	}

	@Override
	public it.ariadne.prova.registration.model.PRUser toUnescapedModel() {
