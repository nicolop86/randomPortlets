...
import it.ariadne.prova.registration.model.PRProductClp;
import it.ariadne.prova.registration.model.PRRegistrationClp;
import it.ariadne.prova.registration.model.PRUserClp;
...
public class ClpSerializer {
		...
		synchronized (ClpSerializer.class) {
			...
			try {
				...
				String portletPropsServletContextName = (String)getMethod.invoke(null,
						"prova-portlet-deployment-context");
			...
			if (Validator.isNull(_servletContextName)) {
				_servletContextName = "prova-portlet";
			}
	...
	public static Object translateOutput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals(
					"it.ariadne.prova.registration.model.impl.PRProductImpl")) {
		...
		if (oldModelClassName.equals(
					"it.ariadne.prova.registration.model.impl.PRRegistrationImpl")) {
		...
		if (oldModelClassName.equals(
					"it.ariadne.prova.registration.model.impl.PRUserImpl")) {
	...
	public static Throwable translateThrowable(Throwable throwable) {
		...
		if (className.equals(
			...
			return new it.ariadne.prova.registration.NoSuchPRProductException();
		}

		if (className.equals(
					"it.ariadne.prova.registration.NoSuchPRRegistrationException")) {
			return new it.ariadne.prova.registration.NoSuchPRRegistrationException();
		}

		if (className.equals(
					"it.ariadne.prova.registration.NoSuchPRUserException")) {
			return new it.ariadne.prova.registration.NoSuchPRUserException();
		}
