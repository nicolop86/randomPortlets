 ...
 * {@link it.ariadne.prova.registration.service.impl.PRUserLocalServiceImpl} and is the
...
public class PRUserLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link it.ariadne.prova.registration.service.impl.PRUserLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static it.ariadne.prova.registration.model.PRUser addPRUser(
	...
	*/
	public static it.ariadne.prova.registration.model.PRUser createPRUser(
		long prUserId) {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static it.ariadne.prova.registration.model.PRUser deletePRUser(
		long prUserId)
	...
	*/
	...
	public static it.ariadne.prova.registration.model.PRUser fetchPRUser(
		long prUserId)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static it.ariadne.prova.registration.model.PRUser getPRUser(
		long prUserId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static it.ariadne.prova.registration.model.PRUser updatePRUser(
		it.ariadne.prova.registration.model.PRUser prUser)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static void addPRRegistrationPRUser(long registrationId,
		long prUserId)
		throws com.liferay.portal.kernel.exception.SystemException {
		getService().addPRRegistrationPRUser(registrationId, prUserId);
	}
	...
	*/
	public static void addPRRegistrationPRUser(long registrationId,
		it.ariadne.prova.registration.model.PRUser prUser)
		throws com.liferay.portal.kernel.exception.SystemException {
		getService().addPRRegistrationPRUser(registrationId, prUser);
	}

	/**
	* @throws SystemException if a system exception occurred
	*/
	public static void addPRRegistrationPRUsers(long registrationId,
		long[] prUserIds)
		throws com.liferay.portal.kernel.exception.SystemException {
		getService().addPRRegistrationPRUsers(registrationId, prUserIds);
	}
	...
	*/
	public static void addPRRegistrationPRUsers(long registrationId,
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		getService().addPRRegistrationPRUsers(registrationId, PRUsers);
	}

	/**
	* @throws SystemException if a system exception occurred
	*/
	public static void clearPRRegistrationPRUsers(long registrationId)
		throws com.liferay.portal.kernel.exception.SystemException {
		getService().clearPRRegistrationPRUsers(registrationId);
	}

	/**
	* @throws SystemException if a system exception occurred
	*/
	public static void deletePRRegistrationPRUser(long registrationId,
		long prUserId)
		throws com.liferay.portal.kernel.exception.SystemException {
		getService().deletePRRegistrationPRUser(registrationId, prUserId);
	}
	...
	*/
	public static void deletePRRegistrationPRUser(long registrationId,
		it.ariadne.prova.registration.model.PRUser prUser)
		throws com.liferay.portal.kernel.exception.SystemException {
		getService().deletePRRegistrationPRUser(registrationId, prUser);
	}

	/**
	* @throws SystemException if a system exception occurred
	*/
	public static void deletePRRegistrationPRUsers(long registrationId,
		long[] prUserIds)
		throws com.liferay.portal.kernel.exception.SystemException {
		getService().deletePRRegistrationPRUsers(registrationId, prUserIds);
	}
	...
	*/
	public static void deletePRRegistrationPRUsers(long registrationId,
		java.util.List<it.ariadne.prova.registration.model.PRUser> PRUsers)
		throws com.liferay.portal.kernel.exception.SystemException {
		getService().deletePRRegistrationPRUsers(registrationId, PRUsers);
	}

	/**
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<it.ariadne.prova.registration.model.PRUser> getPRRegistrationPRUsers(
		long registrationId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getPRRegistrationPRUsers(registrationId);
	}
	...
	*/
	public static java.util.List<it.ariadne.prova.registration.model.PRUser> getPRRegistrationPRUsers(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getPRRegistrationPRUsers(registrationId, start, end);
	}
	...
	*/
	public static java.util.List<it.ariadne.prova.registration.model.PRUser> getPRRegistrationPRUsers(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService()
				   .getPRRegistrationPRUsers(registrationId, start, end,
			orderByComparator);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static int getPRRegistrationPRUsersCount(long registrationId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getPRRegistrationPRUsersCount(registrationId);
	}

	/**
	* @throws SystemException if a system exception occurred
	*/
	public static boolean hasPRRegistrationPRUser(long registrationId,
		long prUserId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().hasPRRegistrationPRUser(registrationId, prUserId);
	}

	/**
	* @throws SystemException if a system exception occurred
	*/
	public static boolean hasPRRegistrationPRUsers(long registrationId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().hasPRRegistrationPRUsers(registrationId);
	}

	/**
	* @throws SystemException if a system exception occurred
	*/
	public static void setPRRegistrationPRUsers(long registrationId,
		long[] prUserIds)
		throws com.liferay.portal.kernel.exception.SystemException {
		getService().setPRRegistrationPRUsers(registrationId, prUserIds);
	}
